...
// In tsx: `import baileys` = function (makeWASocket), named exports on baileysNs
// In native Node ESM: `import baileys` = module namespace, named exports on both
// We try every possible location to be resilient.
