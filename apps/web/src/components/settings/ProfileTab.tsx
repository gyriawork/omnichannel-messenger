      ...
      <div className="rounded-lg bg-white p-6 shadow-xs">
        ...
        <div className="mb-6 flex items-center gap-4">
          <div className="relative">
            ...
            <button
              type="button"
              className="absolute -bottom-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full border-2 border-white bg-slate-100 text-slate-500 transition-colors hover:bg-slate-200"
              title="Upload avatar"
            >
