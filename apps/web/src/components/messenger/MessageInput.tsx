    ...
    <div className="border-t bg-white dark:bg-gray-900">
      ...
      <div className="flex items-end gap-2 p-3">
        ...
        <textarea
          ...
          rows={1}
          className="min-w-0 flex-1 resize-none rounded-xl border border-gray-200 dark:border-gray-700 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50 dark:bg-gray-800"
